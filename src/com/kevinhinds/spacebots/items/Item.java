...
public class Item extends TiledSprite {
	 ...
	 * @param vbom
	 */
	public Item(String name, int id, int tileIndex, String type, float x, float y, float density, float elastic, float friction, ITiledTextureRegion texture, VertexBufferObjectManager vbom) {
	 ...
	 * @return
	 */
	public Item getInstance(float x, float y, String type) {
		return new Item(name, id, tileIndex, type, x, y, density, elastic, friction, getTiledTextureRegion(), getVertexBufferObjectManager());
	}
}